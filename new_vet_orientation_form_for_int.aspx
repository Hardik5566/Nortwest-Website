<%@ Page Title="" Language="C#" MasterPageFile="~/FormMaster.master" AutoEventWireup="true" CodeFile="new_vet_orientation_form_for_int.aspx.cs" Inherits="new_vet_orientation_form_for_int" %>
            ...
            <div class="form-container">
                ...
                <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                                                  <label class="lbl_title">Sign Date</label>

                          <asp:TextBox runat="server" ID="txt_submit_date" TextMode="Date" CssClass="form-control" />                      
                    </div>
                </div>
