<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="special_leave_request_form.aspx.cs" Inherits="special_leave_request_form" %>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <h1>Special Leave Request Form</h1>
                    <ul class="breadcrumb">
                        <li><a href="Default.aspx"><i class="fas fa-home"></i>Home</a></li>
                        <li class="active">Special Leave Request Form</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="site-heading text-center">
                    <div class="col-md-8 col-md-offset-2">
                        <h2>Special Leave Request Form</h2>
                    </div>
                </div>
            </div>
