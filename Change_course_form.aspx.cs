...
public partial class Change_course_form : System.Web.UI.Page
{
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        try
        {
            string contact_no = hd_contact_no.Value.ToString();
            DataSet ds = BAL_Forms.ins_change_course_form(txt_student_no.Text, txt_l_name.Text, txt_given_name.Text, txt_full_name.Text, txt_email.Text,hd_contact_no_code.Value.ToString(), contact_no, txt_street_address.Text, txt_address_2.Text, txt_city.Text, txt_state.Text, txt_zip.Text, ddl_country.SelectedValue.ToString(), "1");
            if (ds.Tables[0].Rows.Count > 0)
            {
                Task.Run(() =>
           {

               Send_Mail.MailWithouAttachment("himanshumakwana8281@gmail.com", "New Change Course Form (" + txt_full_name.Text + ")", mailbody(txt_student_no.Text, txt_l_name.Text, txt_given_name.Text, txt_full_name.Text, txt_email.Text, contact_no, txt_street_address.Text, txt_address_2.Text, ddl_country.SelectedValue.ToString(), txt_state.Text, txt_city.Text, txt_zip.Text), "", "");
           });
        ...
        <table style='border-collapse: collapse; margin-left: auto; margin-right: auto; width: 100%;'>
            ...
            <tr style='border-bottom: 1px solid #d7d7d7; text-align: left'>
                <th colspan='2' style='padding: 10px'>
                    <label style='font-size: 20px; padding-bottom: 10px; color: black'>Change of a course form</label>
                </th>
            </tr>
