...
public partial class application_for_reassessment : System.Web.UI.Page
{
    ...
    protected void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds = BAL_Forms.ins_application_for_reassessment(txt_s_number.Text, txt_s_last_name.Text, txt_s_given_name.Text, txt_s_full_name.Text, txt_email.Text, contactNoCode, contactNo, txt_add.Text, txt_add_line_2.Text, txt_city.Text, txt_state.Text, txt_zip.Text, ddl_country.SelectedValue.ToString(), "1");
        if (ds.Tables[0].Rows.Count > 0)
        {
            Task.Run(() =>
            {
                Send_Mail.MailWithouAttachment("himanshumakwana8281@gmail.com", "New Application For Reassessment (" + txt_s_full_name.Text + ")", mailbody(txt_s_number.Text, txt_s_last_name.Text, txt_s_given_name.Text, txt_s_full_name.Text, txt_email.Text, hd_contact_no_code.Value.ToString() + hd_contact_no.Value.ToString(), txt_add.Text, txt_add_line_2.Text, ddl_country.SelectedValue.ToString(), txt_state.Text, txt_city.Text, txt_zip.Text), "", "");
            });
...
<div style='width: 100%; background-color: #f0f0f0; padding: 50px 0px'>
    <div style='width: 100%; text-align: center; margin-bottom: 15px'>
        ...
        <h2 style='text-align: center'>Application For Reassessment</h2>
    </div>
