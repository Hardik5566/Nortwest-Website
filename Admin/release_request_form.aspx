<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="release_request_form.aspx.cs" Inherits="release_request_form" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="Server">
    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3"><i class="bx bx-file">&nbsp</i> Release Request Form</div>
    </div>
    <div class="card">
            ...
            <asp:GridView ID="grid_data" runat="server" AutoGenerateColumns="false" CssClass="table tbl_bottem_boder align-middle mb-0 grid_data">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Reason For Release">
                        <ItemTemplate>
                            <label>
                                <%# Eval("reason_for_release").ToString().Length > 50  ? Eval("reason_for_release").ToString().Substring(0, 50) + "..."  : Eval("reason_for_release") %>
                            </label>
                        </ItemTemplate>
                    </asp:TemplateField>
