...
public partial class New_Elicos_Orientation : System.Web.UI.Page
{
    ...
    public void bind_data()
    {
        try
        {
            DataSet ds = BAL_Forms.dis_new_elicos_orientation_form(txt_from_date.Text, txt_to_date.Text);
    ...
    protected void grid_sales_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName == "btn_pdf")
            {
                ...
                DataSet ds = BAL_Forms.sel_new_elicos_orientation_form(id);
                if (ds.Tables.Count > 0)
                {
