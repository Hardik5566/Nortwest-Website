...
public partial class Refund : System.Web.UI.Page
{
    ...
    public void bind_data()
    {
        try
        {
            DataSet ds = BAL_Forms.dis_refund_form(txt_from_date.Text, txt_to_date.Text);
    ...
    protected void grid_sales_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName == "btn_pdf")
            {
                ...
                DataSet ds = BAL_Forms.sel_refund_form(id);
                if (ds.Tables.Count > 0)
                {
                    ...
                    string subject = "Refund Form (" + ds.Tables[0].Rows[0]["first_name"].ToString() + " " + ds.Tables[0].Rows[0]["last_name"].ToString() + ")";
