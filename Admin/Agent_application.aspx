<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="~/Admin/Agent_application.aspx.cs" Inherits="Agent_application" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="Server">
    ...
    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3"><i class="bx bx-file">&nbsp</i>Agent Application Form Data</div>
    </div>
    <div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <asp:GridView ID="grid_form" runat="server" OnRowCommand="grid_form_RowCommand" AutoGenerateColumns="false" CssClass="table tbl_bottem_boder align-middle mb-0 grid_data">
                <Columns>
                    <asp:TemplateField HeaderText="Sr">
                     ...
                     <asp:TemplateField HeaderText="Buissness Name">
                        <ItemTemplate>
                            <label>
                                <%# Eval("register_buissness_name") %>
                            </label>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Trading Name">
                        <ItemTemplate>
                            <label>
                                <%# Eval("trading_name") %>
                            </label>
                    ...
                    <asp:TemplateField HeaderText="Action" ItemStyle-Width="100px">
                        <ItemTemplate>
                            <div class="d-flex align-items-center gap-3 fs-6">
                                <asp:LinkButton CommandName="btn_pdf" CommandArgument='<%# Eval("agent_form_id") %>' runat="server" CssClass="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="Form" aria-label="Views">
